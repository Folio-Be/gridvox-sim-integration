...
import type {Unless} from 'execa/types/utils.js';
import type {CommonOptions, Options, SyncOptions} from 'execa/types/arguments/options.js';
import type {ErrorProperties} from 'execa/types/return/final-error.js';
import type {ResultAll} from 'execa/types/return/result-all.js';
import type {ResultStdioArray} from 'execa/types/return/result-stdio.js';
import type {ResultStdioNotAll} from 'execa/types/return/result-stdout.js';
import type {ResultIpcOutput} from 'execa/types/return/result-ipc.js';
