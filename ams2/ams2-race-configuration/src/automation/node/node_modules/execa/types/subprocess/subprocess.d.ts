...
import type {Options} from 'execa/types/arguments/options.js';
import type {Result} from 'execa/types/return/result.js';
import type {PipableSubprocess} from 'execa/types/pipe.js';
import type {
	ReadableOptions,
	WritableOptions,
	DuplexOptions,
	SubprocessAsyncIterable,
} from 'execa/types/convert.js';
import type {IpcMethods, HasIpc} from 'execa/types/ipc.js';
import type {SubprocessStdioStream} from 'execa/types/subprocess/stdout.js';
import type {SubprocessStdioArray} from 'execa/types/subprocess/stdio.js';
import type {SubprocessAll} from 'execa/types/subprocess/all.js';
