...
import {createDeferred} from 'execa/lib/utils/deferred.js';
import {incrementMaxListeners} from 'execa/lib/utils/max-listeners.js';
import {sendMessage} from 'execa/lib/ipc/send.js';
import {throwOnMissingStrict, throwOnStrictDisconnect, throwOnStrictDeadlockError} from 'execa/lib/ipc/validation.js';
import {getIpcEmitter} from 'execa/lib/ipc/forward.js';
import {hasMessageListeners} from 'execa/lib/ipc/outgoing.js';
