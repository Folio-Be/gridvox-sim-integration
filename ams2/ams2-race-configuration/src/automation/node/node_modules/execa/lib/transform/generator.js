...
import {isAsyncGenerator} from 'execa/lib/stdio/type.js';
import {getSplitLinesGenerator, getAppendNewlineGenerator} from 'execa/lib/transform/split.js';
import {getValidateTransformInput, getValidateTransformReturn} from 'execa/lib/transform/validate.js';
import {getEncodingTransformGenerator} from 'execa/lib/transform/encoding-transform.js';
import {
	pushChunks,
	transformChunk,
	finalChunks,
	destroyTransform,
} from 'execa/lib/transform/run-async.js';
import {
	pushChunksSync,
	transformChunkSync,
	finalChunksSync,
	runTransformSync,
} from 'execa/lib/transform/run-sync.js';
